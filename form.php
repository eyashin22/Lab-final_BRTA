...
<style>
body {
    background-image: url('image_d.jpeg');
}
</style>
...
<body>
    <nav class="navbar navbar-expand-lg fixed-top portfolio-navbar gradient navbar-dark"
        ...
        <div class="container"><a href="./index.php"><img src="assets/img/logo.png" width="63" height="63"></a><button
    ...
    <main class="page contact-page">
        <section class="portfolio-block contact">
            <div class="container">
                <form class="shadow-lg" data-bs-theme="light" method="post" , enctype="multipart/form-data" style="background-color: white">
                    <?php
                        if(isset($_GET["msg"])){
                    ...
                    <div class="mb-3"><label class="form-label" for="name">Your Name</label><input
                            class="form-control item" type="text" id="name" name="name" required></div>
                    <div class="mb-3"><label class="form-label" for="subject">NID No</label><input
                            class="form-control item" type="text" id="nid" name="nid" required></div>
                    ...
                    <div class="mb-3"><label class="form-label" for="name">Vehicle No</label><input
                            class="form-control item" type="text" id="vehicleNo" name="vehicleNo" required></div>
                    <div class="mb-3"><label class="form-label" for="name">Vehicle Chassis No</label><input
                            class="form-control item" type="text" id="chassisNo" name="chassisNo" required></div>
                    <div class="mb-3"><label class="form-label" for="name">Present Address</label><input
                            class="form-control item" type="text" id="presentAddress" name="presentAddress" required>
                    </div>
                    <div class="mb-3"><label class="form-label" for="name">Permanent Address</label><input
                            class="form-control item" type="text" id="permanentAddress" name="permanentAddress"
                            required></div>
                    <div class="mb-3"><label class="form-label" for="name">Your Photo</label><input class="form-control"
                            type="file" accept="image/*" id="profile_pic" name="profile_pic" required></div>
                    <div class="mb-3"><label class="form-label" for="name">NID Soft Copy (PDF)</label><input
                            class="form-control" accept="application/pdf" id="nidSoftCopy" name="nidSoftCopy"
                            type="file" required></div>
                    <div class="mb-3 mt-4"><button onclick="validateFormPHP()"
                            class="btn btn-primary btn-lg d-block w-100" name="submit_btn" type="submit">Submit
                            Form</button></div>
                    ...
                    <div class="col-md-4">
                        <div class="card special-skill-item border-0" style="background-color: lightblue;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text" style="text-align: center;"><a href="https://bangabhaban.gov.bd/"
                                        style="color: rgb(0, 0, 174)">President Office</a><br><a
                                        href="https://cabinet.gov.bd/" style="color: rgb(0, 0, 174)">Cabinet
                                        Division</a><br><a href="http://www.rthd.gov.bd/"
                                        style="color: rgb(0, 0, 174)">Road Transport &amp; Highway Division</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
